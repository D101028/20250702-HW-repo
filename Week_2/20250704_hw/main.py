...
def find_data_section(lines: list[str], keyword: str = "證券代號") -> tuple[str, list[str]]:
    """
...
result = pd.DataFrame()
for date in ("20250630", "20250701", "20250702", "20250703", "20250704", ):
    df = create_df(date)
    df.columns
